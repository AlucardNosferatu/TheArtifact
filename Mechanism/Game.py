...
class Entity:
    ...
    def __init__(self, core: Core, ent_id, camera=None):
        self.core = core
        self.ent_id = ent_id
        if camera is None:
...
class World(Entity):
    def __init__(self, core: Core, map_image, cam_x=None, cam_y=None, scale_x=200.0, scale_y=200.0, world_id='0#world'):
        ...
        self.stimulation: dict[str, Button] = {}
